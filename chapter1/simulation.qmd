...
![Examples of Prior Distributions for Scenario 1: (a) Priors for $\alpha$, with the true value equal to $7$, and (b) priors for $\beta$, with the true value equal to $1$.](../images/chapter1/p_priors_v2.png){#fig-prior-analysis fig-alt="Curves representing the prior distributions for shape and rate parameters"}
...
![Coverage Rates for $\alpha$ and $\beta$ Across 40 Replicates for Scenario 1.](../images/chapter1/coverage_alp_be.png){#fig-coverage-alp-be fig-alt="Visual representation of coverage rates for shape and rate parameters"}

![Coverage Rates for $w$ and $\rho$ Across 40 Replicates for Scenario 1.](../images/chapter1/coverage_w_rho.png){#fig-coverage-w-rho fig-alt="Visual representation of coverage rates for weight and dependence parameters"}
