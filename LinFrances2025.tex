...
precipitation patterns (\citeproc{ref-zheng2022construction}{Zheng,
Kottas, and Sansó 2022}) and the network analysis of financial markets
(\citeproc{ref-damico2023network}{D'Amico, De Blasis, and Petroni
2023}). Although the MTD model has primarily been used for modeling time
series, its generalizations has also demonstrated success in modeling
spatial data. Some applications within the spatial context can be found
in Berchtold (\citeproc{ref-berchtold2001estimation}{2001}), Zheng,
Kottas, and Sansó (\citeproc{ref-zheng2023nnmp}{2023b}), and Zheng,
Kottas, and Sansó (\citeproc{ref-zheng2023nnmpdiscrete}{2023a}).
...
\(\texttt{C++}\). Algorithm 1 (Figure~\ref{fig-alg}) requires data, mtd
order, hyperparameters of the priors for \(\alpha\), \(\beta\),
...
algorithm by Zheng, Kottas, and Sansó
(\citeproc{ref-zheng2022construction}{2022}).

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{chapter1/../images/chapter1/alg-1-3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter1/../images/chapter1/coverage_alp_be.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter1/../images/chapter1/coverage_w_rho.png}}
...
Zheng, Kottas, and Sansó (\citeproc{ref-zheng2022construction}{2022}),
in Part I we proposed the copula-based Gamma MTD model, which enables
...
algorithms for fitting. In addition, M. Yang, Cavanaugh, and Zamba
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter2/../images/chapter2/alg-2-3.png}}
...
(\citeproc{ref-zheng2022construction}{Zheng, Kottas, and Sansó 2022}),
these features are not currently implemented. Consequently, it cannot
...
Bergmeir 2023a}). An early survey also reported mixed results, showing
that RNNs including LSTMs outperform classical benchmarks on some
datasets and metrics, but not consistently
...
vanishing gradient issue (\citeproc{ref-bengio1994learning}{Bengio,
Simard, and Frasconi 1994}). Both vanishing and exploding issues can
introduce instability during training and hinder the ability of standard
RNNs to capture long-term dependence in sequence data. In the vanishing
case, gradients become too small to effectively update network weights,
while in the exploding case, gradients grow excessively large, leading
...
include TimeGPT-1 by Nixtla (\citeproc{ref-garza2024timegpt1}{Garza,
Challu, and Mergenthaler-Canseco 2024}), Lag-Llama
...
(\citeproc{ref-gers2000lstmgate}{Gers, Schmidhuber, and Cummins 2000}).
We distinguish between two related decisions: the choice of LSTM variant
and the choice of network architecture.
...
Yu et al. (\citeproc{ref-yu2019reviewlstm}{2019}) and Hewamalage,
Bergmeir, and Bandara (\citeproc{ref-hewamalage2021reviewrnn}{2021}).
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{chapter3/../images/chapter3/lstm_vs_mtd_table_2.png}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter3/../images/chapter3/lstm_vs_mtd_real_diff_n1756.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{chapter3/../images/chapter3/lstm_vs_mtd_real_diff_n200.png}}
...
(\citeproc{ref-zheng2022construction}{Zheng, Kottas, and Sansó 2022}),
these extensions have not yet been implemented. In addition, it is
currently limited to a univariate setting. Consequently, it cannot
effectively model non-stationary data, simultaneously capture the
effects of past observations and relevant predictors, or account for
multivariate dependence. Future research directions include extending
the model to handle non-stationary features, account for variability in
wind speed due to factors such as air density, and incorporate the
dependence of wind speed across different heights.
...
{``Tavg1\_2d\_slv\_nx: MERRA-2 2D, 1-Hourly, Time-Averaged,
Single-Level, Assimilation, Single-Level Diagnostics, V5.12.4.''}
Greenbelt, Maryland, USA: Goddard Earth Sciences Data; Information
Services Center (GES DISC). \url{https://doi.org/10.5067/VJAFPLI1CSIV}.
